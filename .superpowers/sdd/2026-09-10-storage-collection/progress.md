...
Task 6: minor (deferred): add direct coverage for merging a late historical observation into an already-created five-minute rollup bucket; final whole-branch review must triage this.
